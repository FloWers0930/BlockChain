...
const ADMIN_MENU = [
  ...
  { id: "booking", label: "Booking", icon: IconTrendingUp }, // FIXED TYPO: Changed "Booking" to "booking"
...
export default function AdminDashboard() {
  ...
  const menuItems = ADMIN_MENU.map((item) => ({
    ...item,
    active: item.id.toLowerCase() === activeView.toLowerCase(), // Added case-insensitive check
