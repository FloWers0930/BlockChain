...
export default function LocationsView() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-8 space-y-7">
      ...
      {/* ── Header (consistent with DashboardView & AnalyticsView) ─────────── */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          {/* Add New Station button - kept exactly as requested */}
          <button
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <i className="fas fa-map-pin text-blue-500 text-xl"></i>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          disabled={submitting}
                          className="text-red-400 hover:text-red-500 transition-colors text-2xl disabled:opacity-50"
                        >
                          🗑️
                        </button>
                      </div>
      ...
      {/* ADD NEW STATION MODAL (kept exactly as in original) */}
      {showAddModal && (
